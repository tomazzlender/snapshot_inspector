...
class ViewInspector::Snapshot::MailTypeTest < ActiveSupport::TestCase
  ...
  test "::extract" do
    ...
    mail_type = ViewInspector::Snapshot::MailType.extract(mail)
    ...
    assert_equal mail_type.mailer_name, "view_inspector/snapshot/mail_type_test/dummy_mailer"
  ...
  test "::from_hash" do
    ...
    mail_type = ViewInspector::Snapshot::MailType.from_hash(fixture[:data])
