...
class ViewInspector::SnapshotTest < ActiveSupport::TestCase
  test "::persist" do
    ...
    persisted_file_contents = File.read(ViewInspector.configuration.absolute_storage_directory.join("view_inspector/snapshots_controller_test/test_some_controller_action_0.json"))
